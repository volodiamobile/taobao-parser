...
st.set_page_config(page_title="Taobao Parser", page_icon="🛒", layout="wide")
...
st.title("🛒 Парсер товаров Taobao")
...
url = st.text_input("Ссылка на товар Taobao:", placeholder="https://item.taobao.com/item.htm?id=...")

if st.button("🚀 Обработать товар", type="primary", disabled=not url):
    if "taobao.com" not in url:
        st.error("❌ Ссылка должна быть на сайт Taobao")
    else:
